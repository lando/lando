...
var processType = function() {
  ...
  var isElectron = _.has(process, 'versions.electron', false);
  var isChrome = _.has(process, 'versions.chrome', false);
  var isAtom = _.has(process, 'versions.atom-shell', false);
