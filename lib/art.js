  ...
  switch (phase) {
    ...
    case 'update':
      return [
        ...
        '',
        'This app was built using a different version of Lando!',
        `While it may not be necessary, we recommend you ${codeMe('lando rebuild')}.`,
        'This will ensure your app is up to date with the version of Lando you have.',
        '',
        'We also recommend checking out the troubleshooting guide below.',
        chalk.green('https://docs.lando.dev/help/updating.html'),
        '',
        'Regardless, your app has started up correctly.',
        'Here are some vitals:',
        '',
      ].join(os.EOL);
  }
