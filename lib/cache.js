 ...
 */
var cache = {
  basePath: path.join(config.getConfig().userConfRoot, 'cache'),
  mem: {},
  registry: path.join(config.getConfig().userConfRoot, 'cache', 'registry.json')
};
...
exports.get = function(key) {
  ...
  if (getFile(cache.registry)[key] < Date.now() || !config.getConfig().cache) {
