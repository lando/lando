 ...
 */
exports.getId = (compose, project, opts = {}) => buildShell('ps', project, compose, opts, 'attach');
...
exports.pull = (compose, project, opts = {}) => {
  ...
  else return buildShell('ps', project, compose, {}, 'attach');
};
