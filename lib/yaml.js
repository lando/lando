...
module.exports = function(logger) {
   ...
   * @param {String} file - The path to the file to be dumped to
            ...
            case 'string':
                if (varPattern.test(i)) {
                    ...
                    parts.forEach(function (part) {
                        currentObj[key] = i.replace(part, appConfig.custom_variables[part.slice(2, part.length - 1)]);
                    });
                }
              break;
            case 'object':
