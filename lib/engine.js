...
lando.events.on('pre-bootstrap', 1, function(config) {
  ...
  // Get the remote engine ip
  // @TODO: is this consistent on Win/Darwin?
  ...
  config.env.LANDO_ENGINE_HOME = config.home;
  config.env.LANDO_ENGINE_IP = dockerHost;
  config.env.LANDO_ENGINE_REMOTE_IP = rip;
