...
// Defualt supported versions
const defaultSupportedVersions = {
  compose: '1.23.x - 1.25.x',
  desktop: '2.1.0.0 - 2.3.0.0',
  engine: '>= 19.0.0',
};
...
module.exports = class Engine {
  ...
  constructor(daemon = new LandoDaemon(), docker = new Landerode(), compose = () => {}, config = {}) {
    ...
    this.supportedVersions = _.merge({}, defaultSupportedVersions, config.dockerSupportedVersions);
  };
