...
module.exports = class App {
 ...
 /**
  ...
  start() {
    ...
    // Attempt to automatically rebuild if an error occurs
    .catch(err => {
      this.log.error('Detected an error starting your app!');
      this.log.warn('Lando will now attempt to repair itself...');
      this.log.debug(err);
      return this.rebuild();
    });
  };
