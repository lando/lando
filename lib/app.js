 ...
 * @returns {Array} Returns an array of apps from the registry
 * @example
 *
 * // List all the apps
 ...
 * @returns {Object|undefined} Returns an instantiated app object.
 * @example
 *
 ...
 * @returns {Boolean} Returns `true` if the app is running, `false` if not.
 * @example
 *
 ...
 * @since 3.0.0
 * @param {String} appName - The name of the app to get.
 * @returns {Boolean} `true` if app exists, `false` if not
 * @example
 *
 * // Get an app named myapp and start it
 ...
 * @returns {Object} An object of information about the app keyed by its services
 * @example
 *
 * // Return the app info
