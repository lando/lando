...
* [engine](#module_engine)
    ...
    * _inner_
        * [~getNetworks](#module_engine..getNetworks) ⇒ <code>Promise</code>
        * [~createNetwork](#module_engine..createNetwork) ⇒ <code>Promise</code>
        * [~pruneNetworks](#module_engine..pruneNetworks) ⇒ <code>Promise</code>
        ...
        * [~scan(data)](#module_engine..scan) ⇒ <code>Promise</code>
...
**Kind**: event emitted by [<code>engine</code>](#module_engine)  
**Since**: 3.0.0  
<a name="module_engine..getNetworks"></a>

### engine~getNetworks ⇒ <code>Promise</code>
Gets the docker networks.

**Kind**: inner property of [<code>engine</code>](#module_engine)  
...
```
<a name="module_engine..createNetwork"></a>

### engine~createNetwork ⇒ <code>Promise</code>
...
```
<a name="module_engine..pruneNetworks"></a>

### engine~pruneNetworks ⇒ <code>Promise</code>
...
**Kind**: inner method of [<code>engine</code>](#module_engine)  
...
```
<a name="module_engine..scan"></a>

### engine~scan(data) ⇒ <code>Promise</code>
