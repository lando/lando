 ...
 * Add `pcntl` extension to all PHP images
   [910](https://github.com/lando/lando/pulls/910)
...
* Fixed local plugins not having access to all events [#961](https://github.com/lando/lando/issues/961)
