v3.0.0-beta.44 - [TBD](https://github.com/lando/lando/releases/tag/v3.0.0-beta.44)

* Add support for passthrough service type. [#933](https://github.com/lando/lando/issues/933)
