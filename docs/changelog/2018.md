...
v3.0.0-beta.45 - [May 16, 2018](https://github.com/lando/lando/releases/tag/v3.0.0-beta.44)
-------------------------------
...
* Support for [Blackfire](https://blackfire.io) [#511](https://github.com/lando/lando/issues/511)
