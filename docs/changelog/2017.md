v3.0.0-beta.14 - [September 4, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.14)
------------------------------------

**SERIOUSLY, READ THE DOCS: https://docs.lndo.io/**

*  Fixed hang when starting Pantheon recipe [#300](https://github.com/kalabox/lando/issues/300) [#302](https://github.com/kalabox/lando/issues/302) [#311](https://github.com/kalabox/lando/issues/311)
*  Fixed issue grabbing files on different branches for Pantheon recipes [#329](https://github.com/kalabox/lando/issues/329)

v3.0.0-beta.13 - [September 4, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.13)
------------------------------------

**SERIOUSLY, READ THE DOCS: https://docs.lndo.io/**

*  Added an `ASP.net` service [#306](https://github.com/kalabox/lando/issues/306)
*  Added a `MSSQL` service [#320](https://github.com/kalabox/lando/issues/320)
*  Added `joomla` recipe [#321](https://github.com/kalabox/lando/issues/321)

v3.0.0-beta.12 - [September 1, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.12)
------------------------------------

**SERIOUSLY, READ THE DOCS: https://docs.lndo.io/**

*  Added a `python` service [#69](https://github.com/kalabox/lando/issues/69)
...
*  Fixed bug that required `db-import` dbs to be in same dir as `.lando.yml` [#314](https://github.com/kalabox/lando/issues/314)
...
*  Fixed bug where recipe-set proxy config could not be unset [#295](https://github.com/kalabox/lando/issues/295)
*  Added `db-export` command and docs. [#292](https://github.com/kalabox/lando/issues/292)
*  Added new versions to all services where applicable. [#303](https://github.com/kalabox/lando/issues/303)
*  Added `ruby` service. [#68](https://github.com/kalabox/lando/issues/68)

v3.0.0-beta.10 - [August 19, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.10)
----------------------------------
...
*   Changed `name` from an argument to an option in `lando init` [#276](https://github.com/kalabox/lando/issues/276)
*   Changed `pantheon` recipe|method so `lando init` auto-sets the app name [#276](https://github.com/kalabox/lando/issues/276)
*   Changed `github` method so `lando init` auto-sets the app name [#276](https://github.com/kalabox/lando/issues/276)
*   Added support for `.env` file injection [#281](https://github.com/kalabox/lando/issues/281)
*   Added **UNOFFICAL** support for `php 7.1` in Pantheon apps [#278](https://github.com/kalabox/lando/issues/278)
*   Added some docs on how to use lando in a ci environment [#147](https://github.com/kalabox/lando/issues/147) [#149](https://github.com/kalabox/lando/issues/149)
*   Updated `backdrush` version to `0.0.5` for Pantheon apps [#285](https://github.com/kalabox/lando/issues/285)
*   Improved `lando pull` so no files backup degrades to `rsync` [#277](https://github.com/kalabox/lando/issues/277)
*   Improved tooling to support string commands [#282](https://github.com/kalabox/lando/issues/282)
...
*   Fixed bug where app names with `.` in them were silently failing [#283](https://github.com/kalabox/lando/issues/283)
*   Fixed regression that caused machine token to not be saved correctly.

v3.0.0-beta.9 - [August 18, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.9)
---------------------------------
...
v3.0.0-beta.8 - [August 10, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.8)
---------------------------------
...
*   Improved `node` service so you have a decoupled `cli` container [#267](https://github.com/kalabox/lando/issues/267)
*   Changed `tooling` to run on the `engine` instead of the `app` level [#267](https://github.com/kalabox/lando/issues/267)
*   Added `needs` options to `tooling` to boot up dependent services [#267](https://github.com/kalabox/lando/issues/267)
*   Moved proxy dashboard to lesser used port `58086`
*   Fixed `@cleanurl` fails in `pantheon` nginx config. [#266](https://github.com/kalabox/lando/issues/266)
*   Fixed bug where some simultaneous uses of `proxy` and `init` caused errors [#259](https://github.com/kalabox/lando/issues/259)
*   Fixed bug where `load-keys` was not filtering out non-keys [#268](https://github.com/kalabox/lando/issues/268)
...
*   Fixed bug where `pantheon` `lando push` was not asking for a message [#260](https://github.com/kalabox/lando/issues/260)
*   Fixed bug where `pantheon` `lando push/pull` was not using the right environments [#261](https://github.com/kalabox/lando/issues/261)
*   Fixed bugs with using `pantheon` site without using `lando init` [#269](https://github.com/kalabox/lando/issues/269)

v3.0.0-beta.7 - [August 4, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.7)
--------------------------------

*   Fixed URL unknowns

v3.0.0-beta.6 - [August 3, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.6)
--------------------------------

*   Added `lando switch` command to handle `pantheon` multidev [#241](https://github.com/kalabox/lando/issues/241)
*   Added `interactivity` to `pantheon` utility commands [#249](https://github.com/kalabox/lando/issues/249)
*   Added `hhvm` option to `php` [#67](https://github.com/kalabox/lando/issues/67)
*   Added `mongo` service. [#54](https://github.com/kalabox/lando/issues/54)
*   Added `mean` recipe. [#54](https://github.com/kalabox/lando/issues/54)

v3.0.0-beta.5 - [August 2, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.5)
--------------------------------

*   Made `lando pull` more robust for Pantheon recipes [#240](https://github.com/kalabox/lando/issues/240)
*   Added `lando push` command for `pantheon` recipes [#239](https://github.com/kalabox/lando/issues/239)
*   Fixed brittle remote host determination [#231](https://github.com/kalabox/lando/issues/231)

v3.0.0-beta.4 - [August 1, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.4)
--------------------------------

*   Improved addition of `sudoers` to `docker` group
*   Fixed incorrect assertion that `drush alias` does not exist during `lando pull` [#240](https://github.com/kalabox/lando/issues/240)

v3.0.0-beta.3 - [July 31, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.3)
-------------------------------

*   Fixed critical `localtunnel` not found bug.

v3.0.0-beta.2 - [July 31, 2017](https://github.com/kalabox/lando/releases/tag/v3.0.0-beta.2)
-------------------------------

*   Added the `events` framework [#242](https://github.com/kalabox/lando/issues/242)
