...
v3.0.0-beta.23 - [November 11, 2017](https://github.com/lando/lando/releases/tag/v3.0.0-beta.23)
----------------------------------

* Added ability to add global envvars through `config.yml` [#479](https://github.com/lando/lando/issues/479)
* Create composerSwitch key to allow users to disable composer install on start ops. [#464](https://github.com/lando/lando/issues/464)
...
*   Added **UNOFFICAL** support for `php 7.1` in Pantheon apps [#278](https://github.com/lando/lando/issues/278)
...
*   "Fixed" (read "provided better handing for") `user 33 doesnt exist` race condition [#184](https://github.com/lando/lando/issues/184)
...
*   Added abilty to run arbitrary scripts after services start up. [#93](https://github.com/lando/lando/issues/93)
