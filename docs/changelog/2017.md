...
*   Switched `hipache` to `traefik` for proxying. [#169](https://github.com/thinktandem/horoscope/issues/169)
*   Fixed bug causing directly loaded compose files to fail URL scan. [#169](https://github.com/thinktandem/horoscope/issues/169)
