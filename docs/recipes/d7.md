...
You can easily configure/override the Drupal 7 recipe and add in additional `.lando.yml` config such as `services`, `tooling`, and `proxy setting`.
...
You will need to make sure you [extract Drupal 7](https://www.drupal.org/docs/7/installing-drupal-7/step-1-download-and-extract-drupal) into either your application root directory or the subdirectory specified by `webroot` in your recipe config.
...
If you want to try a composer based installation you can use the [example above](https://github.com/kalabox/lando/tree/master/examples/drupal7-2) to get started.

```bash
# Get the lando example
git clone https://github.com/kalabox/lando.git
cd lando/examples/drupal7-2

# Start the app up
lando start

# Install D7 via composer
lando composer install

# Get your database credentials
lando info

# Visit https://d7.lndo.site to complete your installation.
