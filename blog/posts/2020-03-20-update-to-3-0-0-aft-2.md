---
title: Important update on Lando 3.0.0-aft.2
metaTitle: Important update on Lando 3.0.0-aft.2 | Lando
...
<https://github.com/lando/lando/releases/tag/v3.0.0-aft.2>
